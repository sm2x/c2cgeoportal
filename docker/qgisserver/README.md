...
Require this environnement variable:
...
Build the tests docker image with tests dependencies and run acceptance tests.

To ease development acceptances tests are mounted through a docker volume in tests container.
